...
pub(crate) const SYNTHETIC_DIE_RADIUS: i32 = 5;
...
pub(crate) fn validate_process_history(
    lot: &FabLot,
    wafer: &WaferRecord,
    findings: &mut Vec<YieldValidationFinding>,
) {
...
pub(crate) fn validate_process_measurements(
...
pub(crate) fn validate_test_results(
    results: &[TestResult],
    recipe_ids: &BTreeSet<String>,
    lot_ids: &BTreeSet<String>,
    wafer_ids: &BTreeSet<(String, String)>,
...
pub(crate) fn validate_summaries(
    summary_kind: &str,
...
pub(crate) fn validate_correlations(
...
pub(crate) fn validate_lot_wafer_ref(
    label: &str,
    id: &str,
    lot_id: &str,
    wafer_id: &str,
...
pub(crate) fn summary_label(summary: &YieldSummary) -> String {
...
pub fn die_outcomes(results: &[TestResult]) -> Vec<DieOutcome> {
    ...
    struct OutcomeBuilder {
        ...
        pub(crate) failed_tests: u32,
        pub(crate) failure_modes: BTreeSet<FailureMode>,
    }
